package com.app.ai.planner.reminders
...
fun appContentIntent(context: Context): PendingIntent {
    val intent = Intent(context, com.app.ai.planner.ui.MainActivity::class.java)
...
class BriefingReceiver : BroadcastReceiver() {
    override fun onReceive(context: Context, intent: Intent) {
        com.app.ai.planner.work.BriefingWorker.enqueue(context)
        BriefingScheduler.scheduleNext(context)
    }
}
