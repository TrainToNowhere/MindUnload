...
@Composable
fun TypeIcon(
    type: com.app.ai.planner.data.ItemType,
    modifier: Modifier = Modifier,
    tint: Color = Color.Unspecified
) {
    when (type) {
        com.app.ai.planner.data.ItemType.TASK -> TabTasksIcon(modifier, tint)
        com.app.ai.planner.data.ItemType.APPOINTMENT -> TabAppointmentsIcon(modifier, tint)
        com.app.ai.planner.data.ItemType.SHOPPING_ITEM -> TabShoppingIcon(modifier, tint)
        com.app.ai.planner.data.ItemType.NOTE -> KnowledgeIcon(modifier, tint)
        com.app.ai.planner.data.ItemType.IDEA -> IdeasIcon(modifier, tint)
        com.app.ai.planner.data.ItemType.GOAL -> GoalsIcon(modifier, tint)
    }
}
