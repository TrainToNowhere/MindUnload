...
import com.app.ai.planner.ai.BacklogTools
import com.app.ai.planner.ai.MissingApiKeyException
import com.app.ai.planner.ai.ParsedAction
import com.app.ai.planner.ai.dueAtMillis
import com.app.ai.planner.ai.resolveLinkRef
import com.app.ai.planner.ai.toItemType
import com.app.ai.planner.ai.toPriority
import com.app.ai.planner.ai.toPriorityOrNull
import com.app.ai.planner.ai.toRelation
import com.app.ai.planner.ai.toRelationOrDefault
import com.app.ai.planner.data.AttachmentKind
import com.app.ai.planner.data.CaptureStatus
import com.app.ai.planner.data.ChatMessage
import com.app.ai.planner.data.ChatMode
import com.app.ai.planner.data.ItemLink
import com.app.ai.planner.data.ItemType
import com.app.ai.planner.data.LinkOrigin
...
class CaptureWorker(context: Context, params: WorkerParameters) : CoroutineWorker(context, params) {
    ...
    private suspend fun extractImageText(
        ...
        claude: com.app.ai.planner.ai.ClaudeService,
        capture: com.app.ai.planner.data.CaptureRequest,
    ): com.app.ai.planner.data.CaptureRequest {
    ...
    private suspend fun chatAnswer(
        repo: PlannerRepository,
        claude: com.app.ai.planner.ai.ClaudeService,
        research: com.app.ai.planner.ai.ResearchService,
